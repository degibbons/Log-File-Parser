...
Public Class Form1
    ...
    Public dest_path
    Public destination
    Public shift_folder As String = Nothing
    Public justFileName As String
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        If ofd_LogFile.ShowDialog() = Windows.Forms.DialogResult.OK Then
            ...
            dest_path = ofd_LogFile.FileName
            Console.WriteLine(dest_path)
            justFileName = Path.GetFileName(dest_path)
            Console.WriteLine(justFileName)
            'Path.GetDirectoryName(dest_path)
            'Console.WriteLine( & "\" & justFileName)
        End If
    End Sub
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        If FolderBrowserDialog1.ShowDialog() = Windows.Forms.DialogResult.OK Then
            shift_folder = FolderBrowserDialog1.SelectedPath
            Console.WriteLine(shift_folder)
            RadioButton2.Checked = True
            Label21.BackColor = Color.FromArgb(0, 255, 0)
        End If
    End Sub
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        Dim fileReader As String = My.Computer.FileSystem.ReadAllText(dest_path)
        ...
        If matches360.Count > 0 Then
            For Each match As Match In matches360
                ...
                If String.Compare(output_360, "YES", True) = 0 Then
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Dim selectedRB4 As String = Nothing
        ...
        ElseIf RadioButton7.Checked = True Then
            selectedRB4 = "no"
        Else
            MsgBox("A Radio Button for Added to Viscenter Storage? needs to be selected!")
            wbXL.Close()
            appXL.Quit()
        ...
        Dim DataArray As Object = {TextBox1.Text, TextBox2.Text, TextBox3.Text, TextBox4.Text, TextBox5.Text, TextBox6.Text, TextBox7.Text, TextBox8.Text,
            ComboBox1.Text, ComboBox2.Text, TextBox10.Text, TextBox11.Text, TextBox12.Text, TextBox13.Text, TextBox14.Text, TextBox15.Text, TextBox16.Text,
            selectedRB1, TextBox17.Text, TextBox18.Text, selectedRB2, selectedRB3, selectedRB4}

        ws.Range("A" & lRow & ":W" & lRow).Offset(1, 0).Value = DataArray
        ...
        If shift_folder IsNot Nothing Then
            justFileName = Path.GetFileName(dest_path)
            Console.WriteLine(dest_path)
            Console.WriteLine(justFileName)
            Console.WriteLine(shift_folder)

            My.Computer.FileSystem.MoveFile(dest_path, shift_folder & "\" & justFileName)
        End If
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        ComboBox2.Text = "Enter or Select Here"
